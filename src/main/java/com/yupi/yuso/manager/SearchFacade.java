...
public class SearchFacade {
    ...
    public SearchVO searchAll(@RequestBody SearchRequest seachRequest, HttpServletRequest request) {
        String type = seachRequest.getType();
        SearchTypeEnum searchTypeEnum = SearchTypeEnum.getEnumByValue(type);
        ThrowUtils.throwIf(StringUtils.isBlank(type), ErrorCode.PARAMS_ERROR);
        String searchText = seachRequest.getSearchText();
        long current = seachRequest.getCurrent();
        long pageSize = seachRequest.getPageSize();
